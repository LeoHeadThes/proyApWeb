...
<Div class="container-fluid">
    ...
    <title>Zbrush-Curso2</title>
    <h1>Curso de Z-Brush</h1>
    </head>
    <body>
        <div class="divrelative">
        <img src="../Images/z-brush-avanzado.jpg" width="400" height="400">

        <div class="divabsolute">
            <h2>Descripción del curso</h2>
<p  ALIGN="justify">
       Esta herramienta es similar a una masa, pero digital, la cual permite sacar tus ideas de tu cabeza y materializarlas. Este divertido programa ha influido en el cine y los videojuegos al facilitar la creación de personajes. Sirve para esculpir formas en arcilla digital y crear personas, orcos, dragones, animales, monstruos y más creaturas o cosas.

      Su uso es más intuitivo y experimental que otros programas de 3D. Solo que si es necesario usar una tableta estilo Wacom ya que Zbrush también detecta la presión del stylus.
</p>
<h3>Profesor</h3>
<p>David Flor Zepeda</p>
<h3>Precio:</h3>
<h4>$250.00</h4>
<P>
