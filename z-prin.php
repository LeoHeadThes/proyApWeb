...
<Div class="container-fluid">
    ...
    <title>Zbrush-Curso</title>
    <h1>Curso de Z-Brush</h1>
    </head>
    <body>
        <div class="divrelative">
        <img src="../Images/z-brush-novato.jpg" width="400" height="400">

        <div class="divabsolute">
            <h2>Descripción del curso</h2>
<p  ALIGN="justify">
        ZBrush es un software de modelado 3d, escultura y pintura digital que constituye un nuevo paradigma dentro del ámbito de la creación de imágenes de síntesis gracias al original planteamiento de su proceso creativo. ZBrush se encuentra actualmente en la versión 4R8
</p>
<h3>Profesor</h3>
