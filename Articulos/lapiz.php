...
<Div class="container-fluid">
    ...
    <title>Lapiz-Curso</title>
    <h1>Curso de dibujo a lapiz</h1>
    </head>
    <body>
        <div class="divrelative">
        <img src="../Images/dibujo.jpg" width="400" height="400">

        <div class="divabsolute">
            <h2>Descripción del curso</h2>
<p  ALIGN="justify">
        ¿Quién no ha visto dibujos increíbles y ha querido reproducirlos o al menos ha tenido la fantasía de que lo hará en algún momento?. Déjame decirte algo: tú puedes aprender a dibujar. Sé que tendrás miles de pretextos en mente que si ya lo has intentado antes, que si en kinder garden no pudiste dibujar. Nada de eso importa, solo importa que tengas ganas y quierashacerlo.
</p>
<h3>Profesor</h3>
