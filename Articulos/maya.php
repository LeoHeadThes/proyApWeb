...
<Div class="container-fluid">
    ...
    <title>Maya-Curso</title>
    <h1>Curso de autodesk maya</h1>
    </head>
    <body>
        <div class="divrelative">
        <img src="../Images/maya-anim.jpg" width="400" height="400">

        <div class="divabsolute">
            <h2>Descripción del curso</h2>
<p  ALIGN="justify">
        Autodesk Maya es un programa informático dedicado al desarrollo de gráficos 3D por ordenador, efectos especiales y animación. Surgió a partir de la evolución de Power Animator y de la fusión de Alias y Wavefront, dos empresas canadienses dedicadas a los gráficos generados por ordenador.
</p>
<h3>Profesor</h3>
<p>Jhon Walker Wine</p>
<h3>Precio:</h3>
<h4>$250.00</h4>
<P>
