...
<Div class="container-fluid">
    ...
    <title>Frances-Curso</title>
    <h1>Curso de Francés</h1>
    </head>
    <body>
        <div class="divrelative">
        <img src="../Images/frances.jpg" width="400" height="400">

        <div class="divabsolute">
            <h2>Descripción del curso</h2>
<p  ALIGN="justify">
        El francés es la única lengua que, junto al inglés, se habla en los cinco continentes. El número de francófonos supera la cifra de los 200 millones de personas y son 33 los estados que tienen este idioma como lengua oficial o cooficial. Esto te va a permitir poder aprender francés en una gran variedad de países por todo el mundo. El francés es una de las lenguas más habladas en internet, tras el inglés y el alemán, superando incluso al castellano.
</p>
<h3>Profesor</h3>
<p>Pour Votre Bébé</p>
<h3>Precio:</h3>
